...
export default function SEODashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'keywords' | 'performance' | 'competitors' | 'recommendations' | 'reports'>('overview');
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="min-h-[400px]">
                ...
                {activeTab === 'reports' && (
                  <div className="space-y-6">
                    <h3 className="text-2xl font-bold text-white mb-6">Rapor Oluştur</h3>
                    ...
                    {results ? (
                      ...
                      <div className="text-center py-12">
                        ...
                        <h4 className="text-xl font-semibold text-white mb-2">Rapor Oluşturmak İçin Analiz Yapın</h4>
                        <p className="text-gray-400">Önce bir SEO analizi yaparak rapor oluşturabilirsiniz.</p>
                      </div>
                    )}
                  </div>
                )}
